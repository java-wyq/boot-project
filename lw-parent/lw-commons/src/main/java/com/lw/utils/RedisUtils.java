...
public class RedisUtils {
     ...
     * @return List对象
     */
    public static List<Object> getRange(final String key, final int start, final int end) {
    ...
    public static Object rPop(final String key) {
        if (redisTemplate.hasKey(key)) {
            return redisTemplate.opsForList().rightPop(key, 0, TimeUnit.MINUTES);
        } else {
            return null;
        }
    }

    public static void publish(final String key, Object obj) {
        redisTemplate.convertAndSend(key, obj);
    }

    public static Object deserialize(String str) throws SerializationException, UnsupportedEncodingException {
        return redisTemplate.getKeySerializer().deserialize(str.getBytes("utf-8"));
    }
}
